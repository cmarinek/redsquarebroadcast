...
drop policy if exists "Users can read their own content files" on storage.objects;
create policy "Users can read their own content files"
  on storage.objects
...
-- RLS for content_uploads (drop/create to be idempotent)
