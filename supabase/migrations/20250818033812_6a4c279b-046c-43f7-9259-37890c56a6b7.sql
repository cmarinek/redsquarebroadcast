-- Add regional data for the requested regions and countries
-- Insert regions
INSERT INTO public.regions (name, code, timezone, is_active) VALUES
('East Africa', 'east_africa', 'Africa/Nairobi', true),
('East Asia', 'east_asia', 'Asia/Tokyo', true),
('East Europe', 'east_europe', 'Europe/Warsaw', true),
('West Africa', 'west_africa', 'Africa/Lagos', true),
('West Europe', 'west_europe', 'Europe/London', true),
('South Africa', 'south_africa', 'Africa/Johannesburg', true)
