-- Ensure all necessary tables and policies are set up for Red Square platform
...
CREATE INDEX IF NOT EXISTS idx_screens_location ON public.screens USING GIST (ST_Point(location_lng::float, location_lat::float));
